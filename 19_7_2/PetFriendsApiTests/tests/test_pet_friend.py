...
def test_add_new_pet_with_valid_data(name='Варвара', animal_type='ворона',
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Суперкот", "кот", "3", "images/8.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
        print(my_pets)
...
def test_successful_update_self_pet_info(name='Варвара', animal_type='ворона', age=15):
...
def test_head_pet_info_with_valid_key():
    """ Проверяем метод head_pet_info для сервера"""
...
def test_options_pet_info_with_valid_key():
    """ Проверяем метод options_pet_info для сервера"""
